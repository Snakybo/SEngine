...
public abstract class Component
{
	...
	/** This method should be overridden when you need to handle input in a
	 * component
	...
	/** This method should be overridden when you need to update a component, or
	...
	/** This method should be overridden when you require a component to render
	 * something
	 * <p>
	 * The shader that's currently active is passed as a parameter in this
	 * method
	 * </p>
