...
public class Shader {
	...
	public Shader(String fileName) {
		...
		if(oldResource != null) {
			...
			String vertexShaderText = loadShader(fileName + ".v.glsl");
			String fragmentShaderText = loadShader(fileName + ".f.glsl");
	...
	private void addAllUniforms(String shaderText) {
		...
		while(uniformStartLocation != -1) {
			if(!(uniformStartLocation != 0
				...
				uniformStartLocation =
						shaderText.indexOf(UNIFORM_KEYWORD, uniformStartLocation + UNIFORM_KEYWORD.length());
				continue;
			}
