...
public class Attenuation extends Vector3f {
	/** Constructor for the attenuation This constructor calls {@link #Attenuation(float)} with the
	 * parameter {@code 0.0f}
	...
	/** Constructor for the attenuation This constructor calls {@link #Attenuation(float, float)}
	 * with the parameter {@code 0.0f}
