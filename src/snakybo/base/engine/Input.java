...
public class Input {
	...
	/** Set cursor enabled or disabled */
	public static void setCursor(boolean enabled) {
		Mouse.setGrabbed(!enabled);
	}
	
	/** @return Boolean: State of key */
	public static boolean getKey(int keyCode) {
		return Keyboard.isKeyDown(keyCode);
	}
	
	/** @return Boolean: True if key specified is being pressed */
	public static boolean getKeyDown(int keyCode) {
		return getKey(keyCode) && !lastKeys[keyCode];
	}
	
	/** @return Boolean: True if key specified is not being pressed */
	public static boolean getKeyUp(int keyCode) {
		return !getKey(keyCode) && lastKeys[keyCode];
	}
	
	/** @return Boolean: State of mouse button specified */
	public static boolean getMouse(int mouseButton) {
		return Mouse.isButtonDown(mouseButton);
	}
	
	/** @return Boolean: True if mouse button specified is down */
	public static boolean getMouseDown(int mouseButton) {
		return getMouse(mouseButton) && !lastMouse[mouseButton];
	}
	
	/** @return Boolean: True if mouse button specified is not down */
	public static boolean getMouseUp(int mouseButton) {
		return !getMouse(mouseButton) && lastMouse[mouseButton];
	}
	
	/** @return Vector2f: Mouse position */
